            ...
            <section className="flex-1 flex items-center justify-center h-full relative">
                ...
                <div className="max-w-[500px] w-full">
                    <div className="flex justify-center">
                        { isDarkMode ? (
                                <img src={HuginnDark} alt="Dark Huginn with Text" className="w-[65px] h-auto sm:w-[70px] md:w-[80px] lg:w-[120px]"/>
                            ) : (
                    ...
                    <form onSubmit={handleSubmit} className="mx-11">
                        ...
                        <div>
                            ...
                            <button type="submit" disabled={loading} className="block mx-auto w-[70%] cursor-pointer mt-5 py-3 px-3 bg-black hover:bg-gray-600 text-white text-xs rounded-xl font-bold sm:w-[60%] md:mt-9 md:w-[50%] md:text-sm lg:py-2.5 lg:px-9 lg:text-lg
                                                                                dark:bg-white dark:text-black dark:hover:bg-gray-300">Login</button>
                            <p className="block mx-auto my-2.5 text-center text-xs md:text-sm md:my-4
                                         dark:text-[#F1F5F9]">Not registered yet? Click <Link to='/register' className="underline font-bold cursor-pointer">here</Link> to register!</p>
                        </div>
                    </form>
                </div>
            </section>
